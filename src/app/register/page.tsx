    ...
    <main className="flex w-screen h-screen justify-center items-center">
      ...
      <div className="container">
        ...
        <div className="rounded-[0.5rem] border dark:border-gray-700 border-slate-300 md:grid lg:grid-cols-2 min-h-[650px] max-[767px]:min-h-[550px]">
          <div className="md:flex bg-zinc-900 flex-col justify-between px-12 py-8 rounded-l-[0.5rem] border-r dark:border-gray-700 border-slate-300 mix-blend-multiply bg-no-repeat bg-bottom bg-cover bg-[url('/login-bg-d.jpg')] space-y-5 max-[767px]:invisible max-[767px]:h-0 max-[767px]:p-0 ">
          ...
          <div className="flex flex-col w-full justify-center align-middle">            
            <div className="px-8 py-6 md:px-12 justify-center items-center">  
              <section className="flex flex-col justify-center items-center  pt-8 space-y-3">
                  <h3 className="tracking-tight">Welcome to DPro</h3>
                  <p className="text-sm text-slate-500 dark:text-zinc-100/75">Use your email and password to sign up</p>
              </section>    
              <section className="flex flex-col md:px-8 md:py-8 py-8">
                <RegisterForm /> 
                <div className=" md:flex justify-center text-center text-slate-500 dark:text-zinc-100/75 pt-8 mt-6 space-y-2 leading-normal">Already have an account? <div className="flex-col md:flex-row"><Link href="/login" className="text-slate-900 dark:text-zinc-50 hover:underline md:px-1">Login</Link></div></div>      
              </section>
            </div>
          </div>
        </div>
